...
- [data_provider.py](./data_provider.py): pre-requisite, contains data downloader and `pandas.DataFrame` creation
...
These notebooks provide examples of usage of the module `utils_DevTrad` and its functions. They show how the results in the paper have been obtained.
